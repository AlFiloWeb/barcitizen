  ...
  return (
    <section id="schedule" className="w-full">
      <div className="bg-umbracle-2 bg-no-repeat bg-cover bg-bottom text-white p-5 sm:p-20">
        <p className="font-agencyGothicCTBold text-9xl text-shadow mb-20">Programación</p>
        <ul className="list-disc text-4xl font-bold ml-8 flex flex-col gap-10 text-shadow">
