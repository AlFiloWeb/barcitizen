export default function Schedule() {
  return (
    <section id="schedule" className="w-full relative">
      ...
      >
        <div className="w-full flex justify-center items-end title-schedule pl-10 z-20 pt-20 pb-60"></div>
        <div className="bg-no-repeat bg-cover bg-bottom text-white p-5 sm:px-20 pb-60">
          <p className="font-agencyGothicCTBold text-7xl w-full sm:text-9xl text-shadow pr-20 text-white">
            Programación
          </p>
          <ul className="list-disc text-2xl sm:text-4xl font-bold ml-8 flex flex-col gap-10 mt-20 text-shadow">
        ...
        <div className="w-full flex justify-center sm:justify-start title-location self-start sm:pl-10 pb-40"></div>
      </div>
    </section>
  );
}
