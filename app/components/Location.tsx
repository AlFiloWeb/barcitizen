export default function Location() {
  return (
    <section
      id="location"
      className="relative flex justify-center p-5 2xl:p-0 mb-20 text-xl font-semibold"
    >
      <div className="max-w-screen-2xl w-full">
        ...
        <p className="text-center mt-10 mb-5 sm:mt-20 sm:mb-10">
        ...
        <div className="w-full flex justify-center flex-wrap gap-10 xl:flex-nowrap xl:gap-20">
          <div className="basis-full xl:basis-6/12 flex flex-col gap-5">
            <p className="text-center">A las 16:00 desde Estación del norte</p>
            <div className="flex justify-center w-full">
              <iframe
          ...
          <div className="basis-full xl:basis-6/12 flex flex-col gap-5">
            <p className="text-center">A las 16:30 desde Joaquín Sorolla</p>
            <div className="flex justify-center w-full">
              <iframe
