export default function Location() {
  return (
    ...
    >
      <div>
        <p className="font-agencyGothicCTBold text-9xl text-[#581478] text-center">
          Localización
        </p>
        ...
        <p className="text-2xl font-semibold mt-5 text-center">Dirección: Av. del Professor López Piñero, CP. 46013 Valencia.</p>
        ...
        <p className="text-2xl font-semibold text-center mt-20 mb-10">
